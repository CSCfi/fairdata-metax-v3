...
| `/rpc/datasets/flush_user_data`              | `DELETE /v3/user/<id>`                               |
| `/rpc/files/delete_project`                  | `POST /v3/files/delete-project`                      |
| `/rpc/files/flush_project`                   | `POST /v3/files/delete-project` with `{flush: true}` |
