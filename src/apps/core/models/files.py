...
class Checksum(AbstractBaseModel):
...
class File(AbstractBaseModel):
    ...
    checksum = models.OneToOneField(
        Checksum, on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    v2_identifier = models.CharField(max_length=200, null=True, blank=True)
