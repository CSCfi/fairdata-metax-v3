...
def restriction_grounds_reference_data():
    ...
    return bulk_create(
        factories.RestrictionGroundsFactory.build(
...
def field_of_science_reference_data():
    ...
    field = factories.FieldOfScienceFactory.build(
    ...
    broader_field = factories.FieldOfScienceFactory.build(
    ...
    fields = bulk_create(field, field_a, field_b, broader_field)
...
def theme_reference_data():
    ...
    kw1 = factories.ThemeFactory.build(
    ...
    keyword = factories.ThemeFactory.build(
    ...
    broader_keyword = factories.ThemeFactory.build(
    ...
    kw2 = factories.ThemeFactory.build(
    ...
    keywords = bulk_create(keyword, broader_keyword, kw1, kw2)
...
def language_reference_data():
    ...
    return bulk_create(
        factories.LanguageFactory.build(
...
def license_reference_data():
    ...
    return bulk_create(
        factories.LicenseFactory.build(
...
def file_type_reference_data():
    ...
    return bulk_create(
        factories.FileTypeFactory.build(
...
def use_category_reference_data():
    ...
    return bulk_create(
        factories.UseCategoryFactory.build(
...
def identifier_type_reference_data():
    ...
    return bulk_create(
        factories.IdentifierTypeFactory.build(
...
def resource_type_reference_data():
    ...
    return bulk_create(
        factories.ResourceTypeFactory.build(
...
def relation_type_reference_data():
    ...
    return bulk_create(
        factories.RelationTypeFactory.build(
...
def lifecycle_event_reference_data():
    ...
    return bulk_create(
        factories.LifecycleEventFactory.build(
...
def mock_pid_ms(request, requests_mock, settings):
    settings.PID_MS_CLIENT_INSTANCE = "apps.core.services.pid_ms_client._PIDMSClient"
    ...
    requests_mock.register_uri("GET", matcher)
    requests_mock.register_uri("POST", matcher)
    requests_mock.register_uri("PUT", matcher)
    requests_mock.register_uri("PATCH", matcher)
    requests_mock.register_uri("DELETE", matcher)
    yield requests_mock


@pytest.fixture()
def mock_pid_ms_fail(requests_mock, settings):
    settings.PID_MS_CLIENT_INSTANCE = "apps.core.services.pid_ms_client._PIDMSClient"
    matcher = re.compile("http://localhost")
    matcher_doi = re.compile(f"https://{settings.PID_MS_BASEURL}/v1/pid/doi/10.(82614|23729)/")
    requests_mock.register_uri("PUT", matcher_doi, status_code=500, text="something went wrong")
    requests_mock.register_uri("GET", matcher, status_code=500, text="something went wrong")
    requests_mock.register_uri("POST", matcher, status_code=500, text="something went wrong")
    requests_mock.register_uri("PUT", matcher, status_code=500, text="something went wrong")
    requests_mock.register_uri("PATCH", matcher, status_code=500, text="something went wrong")
    requests_mock.register_uri("DELETE", matcher, status_code=500, text="something went wrong")
    yield requests_mock
